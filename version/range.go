...
// Symbolizes the accepted range of a protocol feature or behavior.
// [0] is the build where a behavior was first observed.
// [1] is the build where the feature was last observed (i.e. NOT the build that removes it)
