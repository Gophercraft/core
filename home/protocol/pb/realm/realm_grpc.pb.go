...
func (c *realmServiceClient) Enlist(ctx context.Context, in *EnlistRequest, opts ...grpc.CallOption) (*EnlistResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/realm.RealmService/Enlist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realmServiceClient) Announce(ctx context.Context, in *AnnounceRequest, opts ...grpc.CallOption) (*AnnounceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/realm.RealmService/Announce", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realmServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	out := new(UpdateResponse)
	err := c.cc.Invoke(ctx, "/realm.RealmService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realmServiceClient) SaveCharacterCount(ctx context.Context, in *CharacterCountData, opts ...grpc.CallOption) (*SaveResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/realm.RealmService/SaveCharacterCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realmServiceClient) SaveLastCharacterLoggedIn(ctx context.Context, in *CharacterLoggedInData, opts ...grpc.CallOption) (*SaveResponse, error) {
	out := new(SaveResponse)
	err := c.cc.Invoke(ctx, "/realm.RealmService/SaveLastCharacterLoggedIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRealmServiceServer) Update(context.Context, *UpdateRequest) (*UpdateResponse, error) {
...
func _RealmService_Enlist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realm.RealmService/Enlist",
	}
...
func _RealmService_Announce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realm.RealmService/Announce",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RealmService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realm.RealmService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealmServiceServer).Update(ctx, req.(*UpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RealmService_SaveCharacterCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realm.RealmService/SaveCharacterCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RealmService_SaveLastCharacterLoggedIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/realm.RealmService/SaveLastCharacterLoggedIn",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
