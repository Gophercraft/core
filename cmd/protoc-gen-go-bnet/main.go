// protoc-gen-go-bnet is a plugin for the Google protocol buffer compiler to
// generate Go code. Install it by building this program and making it
// accessible within your PATH with the name:
//
//	protoc-gen-go-bnet
//
// The 'go-bnet' suffix becomes part of the argument for the protocol compiler,
// such that it can be invoked as:
//
//	protoc --go-bnet_out=. path/to/file.proto
//
...
func main() {
	...
	flag.Parse()
	if *showVersion {
		fmt.Printf("protoc-gen-go-bnet %v\n", version)
		return
	}
