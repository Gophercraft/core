...
// Money represents a number of coppers in your inventory.
// Though this type is signed, you can not have a negative balance in-game
type Money int64
...
func (g *Money) EncodeWord() (string, error) {
	return g.ShortString(), nil
}

func (g *Money) DecodeWord(in string) (err error) {
	*g, err = ParseMoneyShort(in)
	return
}
