...
type Request interface {
	Command() Command
	Encode(build version.Build, out *Writer) error
	Decode(build version.Build, in *Reader) error
}
...
func (sd *ServerData) Decode(build version.Build, in *Reader) error {
	for {
...
func (sd *ServerData) Encode(build version.Build, out *Writer) error {
...
func (er emptyRequest) Decode(build version.Build, in *Reader) error {
	return nil
}

func (er emptyRequest) Encode(build version.Build, out *Writer) error {
	return nil
}

func (cd *ClientData) Decode(build version.Build, in *Reader) error {
...
func (cd *ClientData) Encode(build version.Build, out *Writer) error {
