...
func (al *AuctionListing) Encode(version version.Build, e *message.Packet) error {
	e.WriteUint32(al.ID)
...
func (al *AuctionListing) Decode(build version.Build, e *message.Packet) error {
	al.ID = e.ReadUint32()
...
func (alir *AuctionPage) Decode(build version.Build, in *message.Packet) error {
	const maxPage = 100
