...
func (iq *QuerySingle) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.CMSG_ITEM_QUERY_SINGLE
	out.WriteUint32(iq.ID)
	iq.GUID.EncodeUnpacked(build, out)
	return nil
}

func (iq *QuerySingle) Decode(build version.Build, in *message.Packet) error {
	iq.ID = in.ReadUint32()
...
func DmgCount(build version.Build) int {
...
func (ir *ResponseSingle) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.SMSG_ITEM_QUERY_SINGLE_RESPONSE
...
func (ir *ResponseSingle) Decode(build version.Build, in *message.Packet) error {
...
func (ip *Push) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.SMSG_ITEM_PUSH_RESULT
...
func (ip *Push) Decode(build version.Build, in *message.Packet) error {
	var err error
...
func (id *Destroy) Encode(build version.Build, out *message.Packet) error {
	out.WriteInt8(int8(id.Bag))
	out.WriteInt8(int8(id.Slot))
	out.WriteUint8(uint8(id.Count))
	return nil
}

func (id *Destroy) Decode(build version.Build, in *message.Packet) error {
	id.Bag = models.ItemSlot(in.ReadInt8())
	id.Slot = models.ItemSlot(in.ReadInt8())
	id.Count = uint32(in.ReadUint8())
	return nil
}
