...
var TagDescriptors = map[version.BuildRange]TagDescriptor{
	{0, 5875}: {
		TagNone: 0,
		TagAFK:  1,
		TagDND:  2,
...
func (myTag *Tag) Encode(build version.Build, out io.Writer) error {
	var tag TagDescriptor
	if err := version.QueryDescriptors(build, TagDescriptors, &tag); err != nil {
		return err
	}
	code := tag[*myTag]
...
func (myTag *Tag) Decode(build version.Build, in io.Reader) error {
	var tag TagDescriptor
	if err := version.QueryDescriptors(build, TagDescriptors, &tag); err != nil {
		return err
	}
...
func (msg *ServerMessage) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.SMSG_MESSAGECHAT
...
func (msg *ServerMessage) Decode(build version.Build, in *message.Packet) error {
	code := in.ReadUint8()
