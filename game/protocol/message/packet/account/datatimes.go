...
// 3988-6005
func (d *DataTimes) encodeClassic(build version.Build, out *message.Packet) error {
	const (
		nHash  = 8
		szHash = 16
	)
...
// 6180-8303
func (d *DataTimes) encodeTBC(build version.Build, out *message.Packet) error {
	for i := 0; i < 31; i++ {
...
// 8089-8303
func (d *DataTimes) encodePreWotlk(build version.Build, out *message.Packet) error {
	for i := 0; i < 32; i++ {
		out.WriteUint32(d.Times[i])
	}
	return nil
...
func (d *DataTimes) encodeWotlk(build version.Build, out *message.Packet) error {
...
func (d *DataTimes) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.SMSG_ACCOUNT_DATA_TIMES
...
func (d *DataTimes) decodeClassic(build version.Build, in *message.Packet) error {
...
func (d *DataTimes) decodeTBC(build version.Build, in *message.Packet) error {
	for i := 0; i < 31; i++ {
...
func (d *DataTimes) decodePreWotlk(build version.Build, in *message.Packet) error {
	for i := 0; i < 32; i++ {
		d.Times[i] = in.ReadUint32()
	}
	return nil
...
func (d *DataTimes) decodeWotlk(build version.Build, in *message.Packet) error {
...
func (d *DataTimes) Decode(build version.Build, in *message.Packet) error {
	if build <= 6005 {
