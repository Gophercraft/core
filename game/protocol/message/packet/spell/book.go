...
func (c *Cooldown) Encode(build version.Build, out *message.Packet) error {
	switch {
	case build < 9767:
...
func (p *Page) Encode(build version.Build, out *message.Packet) error {
...
func (p *Page) Decode(build version.Build, in *message.Packet) error {
	if build == version.Alpha {
...
func (l *Book) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.SMSG_INITIAL_SPELLS
	out.WriteUint8(l.TalentSpec)
...
func (l *Learned) Encode(build version.Build, out *message.Packet) error {
	out.Type = message.SMSG_LEARNED_SPELL
