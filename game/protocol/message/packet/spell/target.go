...
func (t *TargetLocation) Encode(build version.Build, out *message.Packet) error {
	t.Transport.EncodePacked(build, out)
	return t.Location.Encode(out)
}

func (t *TargetLocation) Decode(build version.Build, in *message.Packet) error {
	var err error
...
func (td *TargetData) Encode(build version.Build, out *message.Packet) error {
...
func (td *TargetData) Decode(build version.Build, in *message.Packet) error {
