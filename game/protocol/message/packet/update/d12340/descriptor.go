...
type PlayerData struct {
	...
	CurrencyTokenSlots [32]guid.GUID `update:"private"`
	FarSight           guid.GUID
...
func init() {
	update.Descriptors[version.Range(9056, 12340)] = &update.Descriptor{
		update.DescriptorOptionClassicGUIDs,
