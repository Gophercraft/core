...
func encodeMovementInfoAlpha(version version.Build, out io.Writer, mi *MovementInfo) error {
...
func (mb *MovementBlock) writeDataAlpha(e *Encoder) error {
	...
	var slist []SpeedType
	if err := version.QueryDescriptors(e.Build, SpeedLists, &slist); err != nil {
		return err
	}
