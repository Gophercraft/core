...
var LoginResultDescriptors = map[version.BuildRange]map[LoginResult]uint8{
	{0, 3368}: {
...
func (l *LoginStatus) Encode(build version.Build, out *message.Packet) error {
	out.Type = l.Type
	out.WriteUint8(uint8(l.Result))
	return nil
}
