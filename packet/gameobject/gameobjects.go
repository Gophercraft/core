...
func (gou *Use) Encode(build vsn.Build, out *packet.WorldPacket) error {
	gou.ID.EncodeUnpacked(build, out)
	return nil
}

func (gou *Use) Decode(build vsn.Build, in *packet.WorldPacket) error {
	var err error
...
func (gq *Query) Encode(build vsn.Build, out *packet.WorldPacket) error {
	out.Type = packet.CMSG_GAMEOBJECT_QUERY
	out.WriteUint32(gq.ID)
	return nil
}

func (gq *Query) Decode(build vsn.Build, in *packet.WorldPacket) error {
	gq.ID = in.ReadUint32()
...
func (gr *QueryResponse) Encode(build vsn.Build, out *packet.WorldPacket) error {
	out.Type = packet.SMSG_GAMEOBJECT_QUERY_RESPONSE
