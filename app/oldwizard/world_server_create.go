...
func CreateWorldServer(showHelp bool) WizFunc {
	return func(w *Wizard, prev WizFunc) WizFunc {
		...
		w.WorldConfigurator.Config.DatabaseEngine = "leveldb_core"
		w.WorldConfigurator.Config.DatabasePath = "world_db"
		...
		if useCV {
			...
			w.WorldConfigurator.Config.Version = version.Build(cliBuild)
		}
