...
const (
	ReportService_SendReport_FullMethodName   = "/bgs.protocol.report.v1.ReportService/SendReport"
	ReportService_SubmitReport_FullMethodName = "/bgs.protocol.report.v1.ReportService/SubmitReport"
)
...
type ReportServiceClient interface {
	SendReport(ctx context.Context, in *SendReportRequest, opts ...rpc.CallOption) (*protocol.NoData, error)
...
func (c *reportServiceClient) SendReport(ctx context.Context, in *SendReportRequest, opts ...rpc.CallOption) (*protocol.NoData, error) {
	out := new(protocol.NoData)
	err := c.cc.Invoke(ctx, ReportService_SendReport_FullMethodName, 0x7CAF61C9, 1, true, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *reportServiceClient) SubmitReport(ctx context.Context, in *SubmitReportRequest, opts ...rpc.CallOption) (*protocol.NoData, error) {
	out := new(protocol.NoData)
	err := c.cc.Invoke(ctx, ReportService_SubmitReport_FullMethodName, 0x7CAF61C9, 2, true, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReportServiceServer interface {
	SendReport(context.Context, *SendReportRequest) (*protocol.NoData, error)
...
func (UnimplementedReportServiceServer) SendReport(context.Context, *SendReportRequest) (*protocol.NoData, error) {
	return nil, status.Errorf(codes.ERROR_RPC_NOT_IMPLEMENTED, "method SendReport not implemented")
}
...
func _ReportService_SendReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor rpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).SendReport(ctx, req.(*SendReportRequest))
	}
...
var ReportService_ServiceDesc = rpc.ServiceDesc{
	ServiceHash: 0x7CAF61C9,
	ServiceName: "bgs.protocol.report.v1.ReportService",
	...
	Metadata: "bgs/low/pb/client/report_service.proto",
}
